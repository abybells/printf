 ...
 * inputs number into the correct base and returns it as a string
 ...
 * Description: the function calls convert() which in turns converts the input number into the correct base and returns it as a string
 * Return: the number of char printed
 */
